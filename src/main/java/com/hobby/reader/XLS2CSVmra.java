...
public class XLS2CSVmra implements HSSFListener {
     ...
     */
    public XLS2CSVmra(String filename, PrintStream output, int minColumns, List<List<String>> returnList) throws IOException, HSSFUserException {
        ...
        req.addListenerForAllRecords(abortableCountingListener);

        HSSFEventFactory f = new HSSFEventFactory();

        f.abortableProcessWorkbookEvents(req, fs);
    }
    ...
    public static void main(String[] args) throws Exception {
        int minColumns = -1;
        if (args.length >= 2) {
            minColumns = Integer.parseInt("5");
        }

        List<List<String>> returnList = new ArrayList<>();
        XLS2CSVmra xls2csv = new XLS2CSVmra("/Users/roshinivr/hobby/ExcelCSVParser/src/main/resources/xls/sample_xls.xls", System.out, minColumns, returnList);
        xls2csv.process();
    }
